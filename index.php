...
<head>
    ...
    if (str == "") {
        ...
        xmlhttp.open("GET","top3.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
    ...
    <div class="container">
        <div class="row">
            <table class="table table-striped">
               ...
               <div class = "col-md-7">
                <table class="table">
                    <h3>Lãi suất tiền gửi cao nhất hôm nay</h3>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        //SELECT order_id FROM orders ORDER BY order_id DESC LIMIT 1;
                                ...
                                while ($row = mysqli_fetch_array($dulieu)){
							;?>
                        <td><?php echo $row['ten_ngan_hang'] ?></td>
                        <td><?php echo $row['gia_tri'] ?></td>
                        <?php
                            }
						    ;?>
                ...
                <h4>3 ngân hàng có lãi suất cao nhất</h4>
                    ...
                    <div id="txtHint"><b>Bảng sẽ hiển thị tại đây</b></div>
