...
<html lang="en">
  <head>
    ...
    <title>Trang sửa thông tin người dùng</title>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtTaiKhoan" type="text" class="form-control" value='<?php echo $row["tai_khoan"];?>'>
                    </div>
                  </div>
                  <br><br><br>
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtMatKhau" type="text" class="form-control" value='<?php echo $row["mat_khau"];?>'>
                    </div>
                  </div>
                  <br><br><br>
